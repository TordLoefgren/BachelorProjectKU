"""
A module that contains logic relating to the creation of QR codes pipelines.
"""
...
def create_qr_video_encoding_pipeline(
    write_video_function: Optional[WriteVideoFunction] = create_video_from_frames,
    read_video_function: Optional[ReadVideoFunction] = create_frames_from_video,
    serialize_function: Optional[SerializeFunction] = None,
    deserialize_function: Optional[DeserializeFunction] = None,
    validation_function: Optional[ValidateFunction] = None,
) -> VideoEncodingPipeline:
    """
